...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.tv_label).text = preferenceHelper.getString(PreferenceHelper.LABEL).toString()
        findViewById<TextView>(R.id.tv_accuracy).text = preferenceHelper.getString(PreferenceHelper.ACCURACY).toString() + "%"
        findViewById<TextView>(R.id.tv_type).text = preferenceHelper.getString(PreferenceHelper.TYPE).toString()
